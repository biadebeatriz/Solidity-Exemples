...
contract MultiSigWallet{
    ...
    //index da transaçao=>address=>aprove/false
    ...
    function _getAprrovalCount(uint _txId) private view returns (uint count){
    ...
    function executed(uint _txId) external txExists(_txId) notExecuted(_txId){
        require(_getAprrovalCount(_txId) >= required, "approvals < required");
